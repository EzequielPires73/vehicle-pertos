      ...
      <div>
        <div className="p-4 pt-2">
          ...
          <div className="mt-3 pt-3 border-t flex justify-between items-center">
            ...
            <Link href={`/comprar/${vehicle.brand.slug}/${vehicle.model.slug}/${vehicle.id}`} className="text-sm font-medium text-blue-500 flex items-center gap-2">Ver detalhes<FiArrowUpRight size={20} /></Link>
          </div>
        </div>
      </div>
    </div>
